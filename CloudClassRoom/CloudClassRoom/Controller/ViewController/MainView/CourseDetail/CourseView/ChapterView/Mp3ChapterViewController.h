...
@protocol Mp3ChapterViewControllerDelegate <NSObject>
...
@interface Mp3ChapterViewController : UITableViewController <CircularProgressViewDelegate, UIAlertViewDelegate> {
...
@property (nonatomic, weak) id<Mp3ChapterViewControllerDelegate> scrollDelegate;
